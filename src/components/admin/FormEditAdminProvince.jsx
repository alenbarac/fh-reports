...
const FormEditAdminProvince = ({ handleCloseEditProvince }) => {

  const [isSubmitted, setIsSubmitted] = useState(false);

  const { loading, provinceUpdated, setProvinceUpdated, showMessage, setShowMessage, adminProvinceCollection } = useGlobalContext();
  const { register, formState: { errors }, reset, handleSubmit } = useForm();
  const [provinceName, setProvinceName] = useState(adminProvinceCollection.provinceName);
  const [provinceIsActive, setProvinceIsActive] = useState(adminProvinceCollection.isActive);
  const [columnLabel1, setColumnLabel1] = useState(adminProvinceCollection.columnLabel1);
  const [columnLabel2, setColumnLabel2] = useState(adminProvinceCollection.columnLabel2);
  const [columnLabel3, setColumnLabel3] = useState(adminProvinceCollection.columnLabel3);
  const [columnLabel4, setColumnLabel4] = useState(adminProvinceCollection.columnLabel4);
  const [columnLabel5, setColumnLabel5] = useState(adminProvinceCollection.columnLabel5);
  const [columnLabel6, setColumnLabel6] = useState(adminProvinceCollection.columnLabel6);
  const [columnLabel7, setColumnLabel7] = useState(adminProvinceCollection.columnLabel7);
  const [columnLabel8, setColumnLabel8] = useState(adminProvinceCollection.columnLabel8);
  const [columnLabel9, setColumnLabel9] = useState(adminProvinceCollection.columnLabel9);
  const [columnLabel10, setColumnLabel10] = useState(adminProvinceCollection.columnLabel10);
  const [columnLabel11, setColumnLabel11] = useState(adminProvinceCollection.columnLabel11);
  const [columnLabel12, setColumnLabel12] = useState(adminProvinceCollection.columnLabel12);
...
export default FormEditAdminProvince