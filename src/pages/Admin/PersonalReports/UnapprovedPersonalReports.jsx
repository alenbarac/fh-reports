...
const UnapprovedPersonalReports = ({ user }) => {
  ...
  const getTableData = () => {
    ...
    apiClient
      .get(`/unapproved_personal_reports`)
      .then((response) => {
              ...
              <CRow>
                <CCol>
                  <CCard className='mb-4'>
                    <CCardHeader className='card-header__darkblue'>Unapproved Personal reports</CCardHeader>
...
export default UnapprovedPersonalReports