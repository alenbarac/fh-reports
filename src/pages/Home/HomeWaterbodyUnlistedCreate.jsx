...
const HomeWaterbodyUnlistedCreate = ({ province, visibleLg, setVisibleLg }) => {
          ...
          >
            ...
            <CCol md={12}>
              ...
              >
                ...
                {province.regions.map((region) => <option key={region.id} value={region.id}>{region.regionName}</option>)}
...
export default HomeWaterbodyUnlistedCreate